...
namespace TheOtherRoles {
    public class CustomOptionHolder {
        ...
        public static void Load() {
            ...
            modifiersCountMin = CustomOption.Create(306, Types.General, cs(new Color(204f / 255f, 204f / 255f, 0, 1f), "最小额外职业数量"), 0f, 0f, 15f, 1f);
            modifiersCountMax = CustomOption.Create(307, Types.General, cs(new Color(204f / 255f, 204f / 255f, 0, 1f), "最大额外职业数量"), 0f, 0f, 15f, 1f);
            ...
            ninjaKnowsTargetLocation = CustomOption.Create(382, Types.Impostor, "忍者可追踪目标位置", true, ninjaSpawnRate);
            ninjaTraceTime = CustomOption.Create(383, Types.Impostor, "追踪时长", 5f, 1f, 20f, 0.5f, ninjaSpawnRate);
            ninjaTraceColorTime = CustomOption.Create(384, Types.Impostor, "追踪颜色消失时长", 2f, 0f, 20f, 0.5f, ninjaSpawnRate);
            ...
            jackalPromotedFromSidekickCanCreateSidekick = CustomOption.Create(228,Types.Neutral, "晋升豺狼后可招募新跟班", true, jackalSpawnRate);
            jackalCanCreateSidekickFromImpostor = CustomOption.Create(229,Types.Neutral, "豺狼可招募内鬼成为他的跟班", true, jackalSpawnRate);
            ...
            deputyGetsPromoted = CustomOption.Create(108,Types.Crewmate, "副官在警长死后可升职长", new string[] { "关闭", "开启 (立即生效)", "开启 (会议后生效)" }, deputySpawnRate);
            ...
            timeMasterSpawnRate = CustomOption.Create(130,Types.Crewmate, cs(TimeMaster.color, "时间领主生成概率"), rates, null, true);
            ...
            // Modifier
            modifierBloody = CustomOption.Create(1000, Types.Modifier, cs(Color.yellow, "血迹生成概率"), rates, null, true);
            ...
            modifierAntiTeleport = CustomOption.Create(1010, Types.Modifier, cs(Color.yellow, "驻足生成概率"), rates, null, true);
            modifierAntiTeleportQuantity = CustomOption.Create(1011, Types.Modifier, cs(Color.yellow, "驻足的数量"), ratesModifier, modifierAntiTeleport);

            modifierTieBreaker = CustomOption.Create(1020, Types.Modifier, cs(Color.yellow, "破平的生成概率"), rates, null, true);
            ...
            modifierSunglasses = CustomOption.Create(1050, Types.Modifier, cs(Color.yellow, "眯眼的生成概率"), rates, null, true);
            modifierSunglassesQuantity = CustomOption.Create(1051, Types.Modifier, cs(Color.yellow, "眯眼的数量"), ratesModifier, modifierSunglasses);
            modifierSunglassesVision = CustomOption.Create(1052, Types.Modifier, "眯眼的视野范围", new string[] { "-10%", "-20%", "-30%", "-40%", "-50%" }, modifierSunglasses);
            ...
            modifierVip = CustomOption.Create(1070, Types.Modifier, cs(Color.yellow, "网红的生成概率"), rates, null, true);
