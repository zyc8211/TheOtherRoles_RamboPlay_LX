...
namespace TheOtherRoles
{
    class RoleInfo {
        ...
        public static RoleInfo lighter = new RoleInfo("执灯人", Lighter.color, "你的烛光永不熄灭", "你的烛光永不熄灭", RoleId.Lighter);
        ...
        // Modifier
        public static RoleInfo bloody = new RoleInfo("血迹的", Color.yellow, "杀死你的人将会留下血迹", "杀死你的人将会留下血迹", RoleId.Bloody, false, true);
        public static RoleInfo antiTeleport = new RoleInfo("驻足的", Color.yellow, "你不会被传送", "你不会被传送", RoleId.AntiTeleport, false, true);
        public static RoleInfo tiebreaker = new RoleInfo("破平的", Color.yellow, "由你裁定平票", "打破僵局", RoleId.Tiebreaker, false, true);
        public static RoleInfo bait = new RoleInfo("引诱的", Color.yellow, "引诱你的敌人", "引诱你的敌人", RoleId.Bait, false, true);
        public static RoleInfo sunglasses = new RoleInfo("眯眼的", Color.yellow, "你瞎了", "你的视野范围缩小了", RoleId.Sunglasses, false, true);
        ...
        public static RoleInfo vip = new RoleInfo("网红的", Color.yellow, "你是尊贵的", "所有人都会知道你死了", RoleId.Vip, false, true);
        public static RoleInfo invert = new RoleInfo("醉鬼的", Color.yellow, "你的操作是反向的", "你的移动是反向的", RoleId.Invert, false, true);
