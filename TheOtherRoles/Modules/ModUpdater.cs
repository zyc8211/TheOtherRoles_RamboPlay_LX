    ...
    public class ModUpdater { 
        ...
        public static async Task<bool> checkForUpdate() {
            try {
                ...
                var response = await http.GetAsync(new System.Uri("https://api.github.com/repos/AlerHugu3s/TheOtherRoles_ZH/releases/latest"), HttpCompletionOption.ResponseContentRead).ConfigureAwait(false);
